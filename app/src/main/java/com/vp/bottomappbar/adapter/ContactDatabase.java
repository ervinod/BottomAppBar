...
public class ContactDatabase {
    ...
    public List<SelectUser> getData() {
        ...
        if (getPhoneNumber != null) {
            ...
            while (getPhoneNumber.moveToNext()) {
                ...
                SelectUser selectUser = new SelectUser(image_thumb, name, phoneNumber, id, false, true);
    ...
    public List<SelectUser> removeDuplicates(List<SelectUser> list) {
        Set set = new TreeSet(new Comparator() {

            @Override
            public int compare(Object o1, Object o2) {
                if (((SelectUser) o1).getName().equalsIgnoreCase(((SelectUser) o2).getName())) {
                    return 0;
                }
                return 1;
            }
